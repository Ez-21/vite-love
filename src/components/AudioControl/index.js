...
const Icon = /*#__PURE__*/React__default.forwardRef((props, ref) => {
  ...
  return /*#__PURE__*/React__default.createElement("span", assign({
    role: "img",
    ref: ref,
    className: classes,
    style: outerStyle
...
const convertIcon = (Svg, iconType) => {
  const InnerIcon = /*#__PURE__*/React__default.forwardRef((props, ref) => /*#__PURE__*/React__default.createElement(Icon, assign({
...
function SvgComponent$5(props) {
  return /*#__PURE__*/React.createElement("svg", assign({
    viewBox: "0 0 24 24",
    fill: "none",
...
const AudioControl = React__default.forwardRef((props, forwardRef) => {
    ...
    let audio = React__default.createRef();
    ...
    return (React__default.createElement("div", { className: [style.AudioControl, show ? style.show : ''].join(' '), onMouseEnter: () => {
            setShow(true);
            const { isShow } = props;
            if (isShow) {
                isShow(true);
        ...
        React__default.createElement("audio", { ref: (r) => {
                if (forwardRef) {
        ...
        React__default.createElement("span", { className: style.showAudioControl, onClick: () => {
                setLock(!lock);
            } }, lock ? React__default.createElement(IconLock, { size: "large" }) : React__default.createElement(IconUnlock, { size: "large" })),
        React__default.createElement("div", { className: [style.control, errorMsg ? style.error : ''].join(' '), "data-errmsg": errorMsg },
            React__default.createElement("div", { className: style.leftContent },
                React__default.createElement(IconBackward, { onClick: () => {
                        const { current } = audio;
                        if (current) {
                ...
                React__default.createElement("div", { className: style.play_pause }, isPlaying ? React__default.createElement(IconPause, { size: "large", onClick: () => {
                        const { current } = audio;
                        if (current) {
                            if (!current.paused) {
                                current.pause();
                    ...
                    } }) : React__default.createElement(IconPlay, { size: "large", onClick: () => {
                        const { current } = audio;
                        if (current) {
                            if (current.paused) {
                                if (haveError) {
                ...
                React__default.createElement(IconFastForward, { onClick: () => {
                        const { current } = audio;
                        if (current) {
                            const { currentTime } = current;
                            current.currentTime = currentTime + 5;
            ...
            React__default.createElement("div", { className: style.rightContent },
                React__default.createElement("div", { className: style.slide, style: { '--val': `${(audioCurrentTime / audioDuration) * 100}%` }, onClick: (e) => {
                    ...
                    React__default.createElement("div", { className: style.Tips, style: { left: `${tipsOffset}px` } }, formatTimer(tipsTime)),
                    React__default.createElement("div", { className: style.sliderBar })),
                React__default.createElement("div", { className: style.timer_box },
                    React__default.createElement("span", { className: style.timer },
                        formatTimer(audioCurrentTime),
                        ":",
                        formatTimer(audioDuration))),
                React__default.createElement("div", { className: [style.double_speed, isHover ? style.hover : ''].join(' '), onMouseEnter: () => {
                        setIsHover(true);
                    }, onMouseLeave: () => { setIsHover(false); } },
                    currentSpeed,
                    "x",
                    React__default.createElement("div", { className: style.speed_list }, speedList.map((v, i) => React__default.createElement("div", { key: i, className: [style.speed_item, currentSpeed === v ? style.active : ''].join(' '), onClick: () => {
                            setCurrentSpeed(v);
                            setIsHover(false);
                        } },
                        v,
